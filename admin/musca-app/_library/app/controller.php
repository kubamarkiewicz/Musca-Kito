<?php
	...
	class App_Controller extends App_Auth
	{
		...
		protected function output($tpl=false, $menu=false)
		{
			...
			// MENU.tpl --- >>
			$this->smarty->assign('auth_mod', $_SESSION[CAPSULE]['auth']['mods']);
			$this->smarty->assign('indelible', $_SESSION[CAPSULE]['auth']['indelible']);
			// --- <<
		...
		function flexJson($table=false, $fields=false, $where='1=1')
		{
			...
			// echo "SELECT $fields FROM $table $where $sort $limit";
