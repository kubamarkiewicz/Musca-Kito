...
(function (i, e){$(e).children('td').each(function(i)
{var tdDiv=document.createElement('div');var pth = $('th:eq(' + i + ')', g.hDiv).get(0);if(pth!=null)
...
{if(g.multisel)
{$(this).toggleClass('trSelected');}},function(){}).dblclick(function()
{p.dblclickFunction(this);});if($.browser.msie&&$.browser.version<7.0)
